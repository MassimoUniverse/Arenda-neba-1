...
# 3. Оптимизируем PNG файлы в uploads (конвертируем в WebP)
echo "🖼️  Оптимизируем изображения..."
if [ -f "optimize-uploads.js" ]; then
    node optimize-uploads.js
    echo "✅ Изображения оптимизированы"
else
    echo "⚠️  Скрипт optimize-uploads.js не найден"
fi
echo ""

# 4. Исправляем пути к изображениям в базе данных
...
# 5. Регенерируем страницы оборудования
