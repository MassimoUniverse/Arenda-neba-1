        ...
        <div class="cookie-consent-row">
          <div class="cookie-consent-text">
            ...
            <div class="cookie-consent-policy-body" hidden>
              <p>
                Мы используем файлы cookie и похожие технологии, чтобы сайт корректно работал, а также для
                сбора обезличенной аналитики и улучшения сервиса. На сайте могут применяться виджеты
                сторонних сервисов (например, Яндекс.Карты и Яндекс.Метрика).
              </p>
              <p>
                Вы можете принять все или выбрать «Только необходимые». Ваш выбор сохраняется на устройстве.
              </p>
            </div>
          </div>
